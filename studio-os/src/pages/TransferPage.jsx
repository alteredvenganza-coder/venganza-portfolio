...
export default function TransferPage() {
  ...
  return (
    <div style={{
      minHeight:      '100vh',
      background:     'linear-gradient(145deg, #0a0a0f 0%, #12121a 40%, #1a1020 100%)',
      display:        'flex',
      ...
      <div style={{
        ...
        width:     '600px',
        height:    '600px',
        background: 'radial-gradient(circle, rgba(123,31,36,0.15) 0%, transparent 70%)',
        pointerEvents: 'none',
      }} />
      ...
      {loading && (
        <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: 14, position: 'relative', zIndex: 1 }}>
          Caricamento...
        </p>
      )}
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 540, width: '100%' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              height:          48,
              borderRadius:    '50%',
              background:      'rgba(123,31,36,0.25)',
              border:          '1px solid rgba(123,31,36,0.4)',
              display:         'flex',
              alignItems:      'center',
              justifyContent:  'center',
            }}>
